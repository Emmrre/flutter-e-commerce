...
extension GlobalPaddingExtension on BuildContext {
  ...
  EdgeInsetsGeometry get globalSymetricH8V8 => const EdgeInsets.symmetric(horizontal: 8,vertical: 8);
  EdgeInsetsGeometry get globalSymetricH16V16 => const EdgeInsets.symmetric(horizontal: 16,vertical: 16);
  ...
  EdgeInsetsGeometry get globalOnlyLeft80x => const EdgeInsets.only(left: 80);
   EdgeInsetsGeometry get globalOnlyLeft80xRight20 => const EdgeInsets.only(left: 80,right: 20);
}
